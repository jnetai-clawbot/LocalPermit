...
import com.jnetai.localpermit.BuildConfig
import com.jnetai.localpermit.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareButton.setOnClickListener {
            startActivity(Intent.createChooser(Intent(Intent.ACTION_SEND).apply {
                type = "text/plain"; putExtra(Intent.EXTRA_TEXT, "Check out LocalPermit! https://github.com/jnetai-clawbot/LocalPermit")
            }, "Share"))
        }
    }
    private fun checkForUpdates() {
        ...
        Thread {
            try {
                val json = JSONObject(URL("https://api.github.com/repos/jnetai-clawbot/LocalPermit/releases/latest").readText())
